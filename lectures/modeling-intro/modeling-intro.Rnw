...
y = 20 + 0.5 x
\]
<<linmod1,echo=false,fig=true,include=false>>=
par(mai=c(0.8,0.8,0.1,0.1))
plot(function(x) 20 + 0.5*x, 0, 10, ylab="y")
@
\begin{center}
  \includegraphics[width=0.6\textwidth]{modeling-intro-linmod1}
\end{center}
\end{frame}
...
y = 20 + 0.5 x - 0.3 x^2
\]
<<linmod2,echo=false,fig=true,include=false>>=
par(mai=c(0.8,0.8,0.1,0.1))
plot(function(x) 20 + 0.5*x - 0.3*x^2 , 0, 10, ylab="y")
@
\begin{center}
  \includegraphics[width=0.6\textwidth]{modeling-intro-linmod2}
\end{center}
\end{frame}
...
\small
<<>>=
beta <- coef(lm(weight ~ length, dietData))
beta
@
\pause
\large
...
\begin{frame}[fragile]
  ...
  \scriptsize %\tiny
<<>>=
lm3 <- lm(weight ~ length + diet, data=dietData)
summary(lm3)
@
\end{frame}
...
<<>>=
X3 <- model.matrix(~length+diet, data=dietData)
X3[20:30,]
@
\end{frame}
...
\begin{frame}[fragile]
  ...
  \tiny
<<>>=
lm4 <- lm(weight ~ diet * length, data=dietData)
summary(lm4)
@
\end{frame}
...
\begin{frame}[fragile]
  ...
  \tiny
<<>>=
X4 <- model.matrix(~ diet * length, data=dietData)
X4[20:30,]
@
\pause
<<>>=
...
%%   \tiny
%% <<>>=
%% lm3 <- lm(weight ~ diet * length + moon, data=dietData)
%% summary(lm3)
%% @
%% \end{frame}
...
%  {\bf Elevation}
  \scriptsize
<<elev,fig=true,include=false,width=6,height=4,echo=false>>=
library(lattice)
levelplot(elevation ~ x + y, data=cruz2, aspect="iso",
          scales=list(draw=FALSE),
          xlab="Easting", ylab="Northing", main="Elevation")
@
\includegraphics[width=\textwidth]{modeling-intro-elev}
\end{frame}
...
%  {\bf Forest cover}
  \scriptsize
<<forest,fig=true,include=false,width=6,height=4,echo=false>>=
levelplot(forest ~ x + y, data=cruz, aspect="iso",
          xlab="",ylab="",main="Forest Cover",
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-forest}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Maps of predictor variables}
%  {\bf Chaparral cover}
<<plots,echo=false,fig=true,include=false,width=6,height=4>>=
...
@
\includegraphics[width=\textwidth]{modeling-intro-plots}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \scriptsize
<<Ejay,fig=true,include=false,width=6,height=4,echo=false>>=
levelplot(fit ~ x + y, data=E6, aspect="iso",
          ...
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-Ejay}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Map the predictions}
  \scriptsize
<<Ljay,fig=true,include=false,width=6,height=4,echo=false>>=
levelplot(lwr ~ x + y, data=E6, aspect="iso",
          xlab="", ylab="", main="Lower CI",
          at=25:55, colorkey=list(space="bottom"),
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-Ljay}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Map the predictions}
  \scriptsize
<<Ujay,fig=true,include=false,width=6,height=4,echo=false>>=
levelplot(upr ~ x + y, data=E6, aspect="iso",
          xlab="", ylab="", main="Upper CI",
          at=25:55, colorkey=list(space="bottom"),
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-Ujay}
\end{frame}
...
future.pred1 <- cbind(cruz2[,c("x","y")], future.pred1)
@
<<future1,fig=true,include=false,width=6,height=4,echo=false>>=
levelplot(fit ~ x + y, data=future.pred1, aspect="iso",
          xlab="", ylab="", main="Expected values",
          at=25:55, colorkey=list(space="bottom"),
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-future1}
\end{frame}
...
future.pred2 <- cbind(cruz2[,c("x","y")], future.pred2)
@
<<future2,echo=false,fig=true,include=false,width=6,height=4>>=
levelplot(fit ~ x + y, data=future.pred2, aspect="iso",
          ...
          scales=list(draw=FALSE))
@
\includegraphics[width=\textwidth]{modeling-intro-future2}
\end{frame}
