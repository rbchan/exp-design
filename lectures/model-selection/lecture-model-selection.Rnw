...
%  \vspace{0.5cm}
%  {\bf ... and this:} \\
%  \url{http://tolstoy.newcastle.edu.au/R/help/06/02/21794.html}
\end{frame}
...
%  \Large
%  \begin{itemize}
%    \item<1-> Comparison of 2 models
    Comparison of 2 models
      \begin{itemize}
        \item $F$-test
        \item Likelihood-ratio ($\chi^2$) test
      \end{itemize}
%    \item<2-> Stepwise procedures
      \pause
    Stepwise procedures
      \begin{itemize}
      ...
      \end{itemize}
%    \item<3-> Information-theortic approaches
      \pause
...
%    \item<4-> Cross-validation
    ...
    Cross-validation
      ...
      \end{itemize}
%    \item<5-> Out-of-sample validation
      \pause
...
%    \item Null hypotheses are rarely true
    ...
    \pause
    \vfill
%    \item $P$-value tells us nothing about the alternative hypothesis
...
%    \item Specification of $\alpha$ is arbitrary
    ...
    \pause
    \vfill
%    \item Significance is a function of sample size
...
%    \item Many statistical tests are only valid as sample size tends
%      toward infinity! (in asymptopia)
%  \end{itemize}
  \pause
  \vfill
  \centering \bf
...
%    \item But, just like any method, it is easy to abuse
    \pause
    \vfill
