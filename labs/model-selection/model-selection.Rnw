...
if(1==2) {
    ## Usage:
    rnw2pdf("model-selection") # Don't include the file extension
    rnw2pdf("model-selection", clean=FALSE) # Don't clean intermediate files
    rnw2pdf("model-selection", tangle=TRUE) # If you want the .R file
}
@
