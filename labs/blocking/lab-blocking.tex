...
\begin{frame}
  ...
  \tiny
%  \scriptsize
%  Due prior to your lab section on the week of Oct 5. \par
...
%  \tiny
%  \vfill
%%  Upload the R script to ELC. The script should not include any
%%  output, just commands and comments. We should be able to copy and
%%  paste it into the R console to get the correct results.
%  This exericse will not be graded, but this material will be on the
%  next exam \\
