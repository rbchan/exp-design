...
%  \pause
  ...
  %% the interface.
  You are encouraged to use these programs, rather than the default GUI, to run R. However, instruction will focus on \R~itself, not on the details or Emacs or RStudio. 
\end{frame}
...
\hlkwd{ls}\hlstd{()}                         \hlcom{## Objects are back}
\end{alltt}
\begin{verbatim}
## [1] "mydata"  "reqval"  "rnw2pdf"
\end{verbatim}
