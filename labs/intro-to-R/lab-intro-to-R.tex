...
%\newcommand{\inr}[1]{\colorbox{inlinecolor}{\makebox[1em]\strut\textcolor{black}{\texttt{#1}}}}
\newcommand{\inr}[1]{\colorbox{inlinecolor}{\normalsize \texttt{#1}}}
...
%%% NOTE: Conduct survey asking who has used R
\begin{frame}[plain]
  \LARGE
%  \maketitle
  {\centering
...
%  {\Large Important things to know about objects:}
  \begin{itemize}[<+->]
    \item Everything in \R~is an object %and every object has a class.
...
%    \item The \colorbox{inlinecolor}{\texttt{<-}} arrow assigns the value y to the object \texttt{y}.
    \item The \inr{<-} arrow assigns the value \inr{y} to the object \inr{y}.
    \item You cannot have a space between \inr{<} and \inr{-}
    \item You can use \inr{=} instead of \inr{<-} but this can cause confusion
