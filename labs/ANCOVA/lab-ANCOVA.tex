...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{girth} \hlkwb{<-} \hlstd{dietData}\hlopt{$}\hlstd{girth}
\hlstd{nd} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{girth}\hlstd{=}\hlkwd{seq}\hlstd{(}\hlkwd{min}\hlstd{(girth),} \hlkwd{max}\hlstd{(girth),} \hlkwc{length}\hlstd{=}\hlnum{50}\hlstd{))}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{summary}\hlstd{(}\hlkwd{lm}\hlstd{(weight} \hlopt{~} \hlstd{diet, dietData))}
\end{alltt}
\begin{verbatim}
## 
## Call:
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dietData}\hlopt{$}\hlstd{girthCentered} \hlkwb{<-} \hlstd{dietData}\hlopt{$}\hlstd{girth} \hlopt{-} \hlkwd{mean}\hlstd{(dietData}\hlopt{$}\hlstd{girth)}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fm3} \hlkwb{<-} \hlkwd{lm}\hlstd{(weight} \hlopt{~} \hlstd{girthCentered} \hlopt{+} \hlstd{diet, dietData)}
\end{alltt}
\end{kframe}
\end{knitrout}
{
...
## 
## Call:
## lm(formula = weight ~ girthCentered + diet, data = dietData)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
...
## girthCentered   0.5573     0.0594   9.382  5.2e-13 ***
...
\begin{verbatim}
##               Df Sum Sq Mean Sq F value   Pr(>F)    
## girthCentered  1 278.25  278.25  80.095 2.54e-12 ***
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{girthC} \hlkwb{<-} \hlstd{dietData}\hlopt{$}\hlstd{girthCentered}
\hlstd{nd3} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}
    ...
    \hlkwc{girthCentered}\hlstd{=}\hlkwd{rep}\hlstd{(}\hlkwd{seq}\hlstd{(}\hlkwd{min}\hlstd{(girthC),} \hlkwd{max}\hlstd{(girthC),}
